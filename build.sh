...
# HarvestHelper Plugin Build and Deploy Script
...
readonly PLUGIN_NAME="HarvestHelper"
readonly PLUGIN_ARTIFACT_ID="HarvestHelper"

# GitHub configuration
readonly GITHUB_REPO="Staticpast/HarvestHelper"
...
Build and deploy the HarvestHelper plugin with intelligent change detection.
...
main() {
    ...
    log_info "Starting HarvestHelper plugin build and deployment..."
